    ...
    constructor(account, lastwill, deathnote) {
        ...
        account.on('BeingJailed', () => {
            if (!this.alreadyJailed) {
                setTimeout(() => account.chat(this.fakerole), 2000);
                defend();
